...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ISU_working_path.otherInfo'
        db.add_column('WeblvnApp_isu_working_path', 'otherInfo', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ISU_working_path.otherInfo'
        db.delete_column('WeblvnApp_isu_working_path', 'otherInfo')

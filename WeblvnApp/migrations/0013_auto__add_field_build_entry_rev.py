...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Build_entry.rev'
        db.add_column('WeblvnApp_build_entry', 'rev', self.gf('django.db.models.fields.CharField')(default=0, max_length=30), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Build_entry.rev'
        db.delete_column('WeblvnApp_build_entry', 'rev')
    ...
    models = {
        ...
        'WeblvnApp.build_entry': {
            ...
            'rev': ('django.db.models.fields.CharField', [], {'max_length': '30'})
        },
        'WeblvnApp.dbupdate': {

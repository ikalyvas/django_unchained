...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'KBEntry'
        db.create_table('WeblvnApp_kbentry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('brief_desc', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('det_desc', self.gf('django.db.models.fields.CharField')(max_length=1000)),
            ('result_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('WeblvnApp', ['KBEntry'])


    def backwards(self, orm):
        
        # Deleting model 'KBEntry'
        db.delete_table('WeblvnApp_kbentry')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ISU_working_path.type_of'
        db.add_column('WeblvnApp_isu_working_path', 'type_of', self.gf('django.db.models.fields.CharField')(default=0, max_length=4), keep_default=False)

        # Changing field 'ISU_working_path.test_date'
        db.alter_column('WeblvnApp_isu_working_path', 'test_date', self.gf('django.db.models.fields.DateField')())


    def backwards(self, orm):
        
        # Deleting field 'ISU_working_path.type_of'
        db.delete_column('WeblvnApp_isu_working_path', 'type_of')

        # Changing field 'ISU_working_path.test_date'
        db.alter_column('WeblvnApp_isu_working_path', 'test_date', self.gf('django.db.models.fields.DateTimeField')())

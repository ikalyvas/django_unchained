...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'KBEntry.category'
        db.alter_column('WeblvnApp_kbentry', 'category', self.gf('django.db.models.fields.CharField')(max_length=20))


    def backwards(self, orm):
        
        # Changing field 'KBEntry.category'
        db.alter_column('WeblvnApp_kbentry', 'category', self.gf('django.db.models.fields.CharField')(max_length=10))

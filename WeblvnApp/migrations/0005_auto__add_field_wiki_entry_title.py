...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Wiki_entry.title'
        db.add_column('WeblvnApp_wiki_entry', 'title', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Wiki_entry.title'
        db.delete_column('WeblvnApp_wiki_entry', 'title')

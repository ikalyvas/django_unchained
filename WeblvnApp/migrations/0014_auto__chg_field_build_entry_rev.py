...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Build_entry.rev'
        db.alter_column('WeblvnApp_build_entry', 'rev', self.gf('django.db.models.fields.IntegerField')())


    def backwards(self, orm):
        
        # Changing field 'Build_entry.rev'
        db.alter_column('WeblvnApp_build_entry', 'rev', self.gf('django.db.models.fields.CharField')(max_length=30))

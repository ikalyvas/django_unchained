...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Build_entry'
        db.create_table('WeblvnApp_build_entry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('build', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ...
            ('rel', self.gf('django.db.models.fields.CharField')(default='-', max_length=30, null=True, blank=True)),
        ))
        db.send_create_signal('WeblvnApp', ['Build_entry'])


    def backwards(self, orm):
        
        # Deleting model 'Build_entry'
        db.delete_table('WeblvnApp_build_entry')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Build_entry.dt'
        db.add_column('WeblvnApp_build_entry', 'dt', self.gf('django.db.models.fields.DateField')(default=datetime.date(2013, 2, 13)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Build_entry.dt'
        db.delete_column('WeblvnApp_build_entry', 'dt')

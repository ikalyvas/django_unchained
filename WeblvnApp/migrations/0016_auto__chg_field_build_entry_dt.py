...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Build_entry.dt'
        db.alter_column('WeblvnApp_build_entry', 'dt', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))


    def backwards(self, orm):
        
        # Changing field 'Build_entry.dt'
        db.alter_column('WeblvnApp_build_entry', 'dt', self.gf('django.db.models.fields.DateField')(default=''))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ISU_working_path.path_id'
        db.add_column('WeblvnApp_isu_working_path', 'path_id', self.gf('django.db.models.fields.CharField')(default=0, max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ISU_working_path.path_id'
        db.delete_column('WeblvnApp_isu_working_path', 'path_id')
    ...
    models = {
        ...
        'WeblvnApp.isu_working_path': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'path_id': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
